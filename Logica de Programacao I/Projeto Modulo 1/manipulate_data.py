...
if __name__ == '__main__':
    # Cria uma lista referente ao restaurante para ser salva
    restaurant = [['Restaurante A', 'Endereço A', 'Telefone A', 'Especialidade A'], ['Restaurante B', 'Endereço A', 'Telefone B', 'Especialidade B']]
    # Cria uma lista com os nomes das colunas
    column_name = ['Nome', 'Endereço', 'Telefone', 'Especialidade']
